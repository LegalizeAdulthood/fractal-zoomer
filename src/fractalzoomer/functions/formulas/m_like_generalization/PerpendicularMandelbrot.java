...
public class PerpendicularMandelbrot extends Julia {
    ...
    public void function(Complex[] complex) {
        ...
        complex[0].absNegateRe_mutable().square_mutable().plus_mutable(complex[1]);
    ...
    public Complex function(Complex z, Complex c) {
        return z.absNegateRe_mutable().square_mutable().plus_mutable(c);
    }
