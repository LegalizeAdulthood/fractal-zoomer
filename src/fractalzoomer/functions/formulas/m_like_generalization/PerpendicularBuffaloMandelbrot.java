...
public class PerpendicularBuffaloMandelbrot extends Julia {
    ...
    public void function(Complex[] complex) {
        ...
        complex[0].absNegateIm_mutable().square_mutable().absre_mutable().plus_mutable(complex[1]);
    ...
    public Complex function(Complex z, Complex c) {
        return z.absNegateIm_mutable().square_mutable().absre_mutable().plus_mutable(c);
    }
