   ...
   static {
    ...
    public FiltersOptionsFrame(MainWindow ptra, int[] filters_options_vals2, int[][] filters_options_extra_vals2, Color[] filters_colors2, Color[][] filters_extra_colors2, JCheckBoxMenuItem[] filter_names, int[] filter_order, boolean[] active_filters, FiltersSettings fs) {
       ...
       ((JPanel)components_filters[MainWindow.EDGE_DETECTION]).setLayout(new GridLayout(5, 1));
        ...
        final JLabel filter_color_label5 = new JLabel();
        
        filter_color_label5.setPreferredSize(new Dimension(22, 22));
        filter_color_label5.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
        filter_color_label5.setBackground(filters_colors[MainWindow.EDGE_DETECTION]);
        filter_color_label5.setOpaque(true);
       ...
       ((JPanel)components_filters[MainWindow.EMBOSS]).setLayout(new GridLayout(6, 1));
        ...
        panels[MainWindow.EMBOSS].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Emboss", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.HISTOGRAM_EQUALIZATION].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Histogram Equalization", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        final JSlider posterize_slid = new JSlider(JSlider.HORIZONTAL, 1, 256, filters_options_vals[MainWindow.POSTERIZE]);
        posterize_slid.setPreferredSize(new Dimension(200, 35));
        ...
        ((JPanel)components_filters[MainWindow.POSTERIZE]).add(posterize_slid);
        
        panels[MainWindow.POSTERIZE].add(((JPanel)components_filters[MainWindow.POSTERIZE]));
        panels[MainWindow.POSTERIZE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Posterize", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.CONTRAST_BRIGHTNESS].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Contrast/Brightness", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.COLOR_TEMPERATURE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Color Temperature", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.INVERT_COLORS].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Inverted Colors", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.COLOR_CHANNEL_MASKING].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Mask Color Channel", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.COLOR_CHANNEL_SWAPPING].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Color Channel Swapping", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.COLOR_CHANNEL_SWIZZLING].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Color Channel Swizzling", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.GRAYSCALE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Grayscale", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.COLOR_CHANNEL_ADJUSTING].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Color Channel Adjusting", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.COLOR_CHANNEL_HSB_ADJUSTING].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Color Channel HSB Adjusting", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.DITHER].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Dither", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.GAIN].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Gain/Bias", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.GAMMA].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Gamma", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.EXPOSURE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Exposure", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.BLURRING].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Blurring", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.CRYSTALLIZE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Crystallize", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        final JLabel filter_color_label2 = new JLabel();   
        
        filter_color_label2.setPreferredSize(new Dimension(22, 22));
        filter_color_label2.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
        filter_color_label2.setBackground(filters_colors[MainWindow.POINTILLIZE]);
        filter_color_label2.setOpaque(true);
        ...
        panels[MainWindow.POINTILLIZE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Pointillize", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.OIL].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Oil", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.MARBLE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Marble", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        final JLabel filter_color_label3 = new JLabel();
        
        filter_color_label3.setPreferredSize(new Dimension(22, 22));
        filter_color_label3.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
        filter_color_label3.setBackground(filters_colors[MainWindow.WEAVE]);
        filter_color_label3.setOpaque(true);
        ...
        panels[MainWindow.WEAVE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Weave", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        final JLabel filter_color_label4 = new JLabel();
                
        filter_color_label4.setPreferredSize(new Dimension(22, 22));
        filter_color_label4.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
        filter_color_label4.setBackground(filters_colors[MainWindow.SPARKLE]);
        filter_color_label4.setOpaque(true);
        ...
        panels[MainWindow.GLOW].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Glow", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.COLOR_CHANNEL_SCALING].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Color Channel Scaling", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        panels[MainWindow.NOISE].setBorder(BorderFactory.createTitledBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(), BorderFactory.createLoweredBevelBorder()), "Noise", TitledBorder.DEFAULT_POSITION, TitledBorder.DEFAULT_POSITION));
        ...
        final JSlider blue_green_slid = new JSlider(JSlider.HORIZONTAL, 0, 255, (int)(((int)(filters_options_vals[MainWindow.COLOR_CHANNEL_MIXING] % 1000000.0)) % 1000.0));
        ...
        blue_green_slid.setToolTipText("Sets the percentange of blue and green.");
        ...
        final JSlider to_red_slid = new JSlider(JSlider.HORIZONTAL, 0, 255, filters_colors[MainWindow.COLOR_CHANNEL_MIXING].getRed());
        ...
        to_red_slid.setToolTipText("Sets the percentange into red.");
        ...
        final JSlider red_blue_slid = new JSlider(JSlider.HORIZONTAL, 0, 255, (int)(((int)(filters_options_vals[MainWindow.COLOR_CHANNEL_MIXING] % 1000000.0)) / 1000.0));
        ...
        red_blue_slid.setToolTipText("Sets the percentange of red and blue.");
        ...
        final JSlider to_green_slid = new JSlider(JSlider.HORIZONTAL, 0, 255, filters_colors[MainWindow.COLOR_CHANNEL_MIXING].getGreen());
        ...
        to_green_slid.setToolTipText("Sets the percentange into green.");
        ...
        final JSlider green_red_slid = new JSlider(JSlider.HORIZONTAL, 0, 255, (int)(filters_options_vals[MainWindow.COLOR_CHANNEL_MIXING] / 1000000.0));
        ...
        green_red_slid.setToolTipText("Sets the percentange of green and red.");
        ...
        final JSlider to_blue_slid = new JSlider(JSlider.HORIZONTAL, 0, 255, filters_colors[MainWindow.COLOR_CHANNEL_MIXING].getBlue());
        ...
        to_blue_slid.setToolTipText("Sets the percentange into blue.");
