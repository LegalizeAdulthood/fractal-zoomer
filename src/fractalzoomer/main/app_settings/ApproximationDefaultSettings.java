...
public class ApproximationDefaultSettings {
    ...
    public static double Stage0PeriodDetectionThreshold = 0x1.0p-5;//Imagina: 0x1.0p-10;
    public static double PeriodDetectionThreshold = 0x1.0p-10;
    public static double Stage0PeriodDetectionThreshold2 = 0x1.0p-3; //Imagina: 0x1.0p-6
    ...
    public static double PeriodDivisor = 4;
